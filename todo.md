...
- [X] 005: Finalizar e integrar o parser para arquivos MoTeC `.ldx` (formato do ACC), permitindo a importação correta de voltas e dados.
...
- [ ] 009: Reportar resultados e entregar versão funcional ao usuário.
